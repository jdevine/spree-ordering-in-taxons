...
desc 'Generate documentation for the ordering_in_taxons extension.'
Rake::RDocTask.new(:rdoc) do |rdoc|
  rdoc.rdoc_dir = 'rdoc'
  rdoc.title    = 'OrderingInTaxonsExtension'
...
desc 'Test the ordering_in_taxons extension.'
...
namespace :test do
  desc 'Functional test the ordering_in_taxons extension.'
  ...
  desc 'Unit test the ordering_in_taxons extension.'
